      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            We're working on tools that will get you to your dream university
            or degree apprenticeship, with tailored advice on UCAS applications,
            personal statements, CV's and more. Check back soon!
          </p>
        </div>
      </div>
    </div>
